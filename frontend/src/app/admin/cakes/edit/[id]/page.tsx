...
export default function EditCake() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!res.ok) {
        throw new Error(data.message || "Failed to update cake");
      }
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6 text-foreground font-sans">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold text-foreground">Edit Cake</h1>
          <p className="text-foreground/70 mt-1">Update the details of your cake</p>
        </div>
      </div>
            ...
            <div className="flex items-start gap-6">
              <div
                className={`relative w-40 h-40 rounded-xl overflow-hidden border-2 border-dashed ${
                  imagePreview && imageFile ? "border-transparent" : "border-gray-300 bg-gray-50"
              ...
              <div className="text-sm text-foreground/60 mt-2">
                ...
                <p>Leave empty to keep the existing photo.</p>
